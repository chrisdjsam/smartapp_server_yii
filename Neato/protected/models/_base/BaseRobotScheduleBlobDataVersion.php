...
/**
 * This is the model class for table "robot_schedule_blob_data_versions".
 *
 * The followings are the available columns in table 'robot_schedule_blob_data_versions':
 * @property string $id
 ...
 */
class BaseRobotScheduleBlobDataVersion extends GxActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BaseRobotScheduleBlobDataVersion the static model class
	 */
	...
	{
		return 'robot_schedule_blob_data_versions';
	}
