...
/**
 * This is the model class for table "robot_map_xml_data_versions".
 *
 * The followings are the available columns in table 'robot_map_xml_data_versions':
 * @property string $id
 ...
 */
class BaseRobotMapXmlDataVersions extends GxActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BaseRobotMapXmlDataVersions the static model class
	 */
	...
	{
		return 'robot_map_xml_data_versions';
	}
