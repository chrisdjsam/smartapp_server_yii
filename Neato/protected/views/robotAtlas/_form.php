<div class="form">
	...
	<div class="row-buttons">
		...
		<a href="<?php echo $this->createUrl('robot/view',array('h'=>AppHelper::two_way_string_encrypt($id)))?>" title="Cancel"
			class="neato-button" id="cancel_upload">Cancel</a>
		<?php if(!$model->isNewRecord){?>
		<a class="delete-robot-atlas neato-button"
			href=<?php echo $this->createUrl('api/RobotAtlas/delete',array('atlas_id'=> $model->id))?>
