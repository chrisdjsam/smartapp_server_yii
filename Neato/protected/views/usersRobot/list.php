...
<fieldset class='data-container static-data-container'>
	...
	<p class="list_details">
		All the user-robot associations are listed below.
		<br />
		You can also select a row and click on delete button to delete a user-robot associations.
		<br />
		You can view user profile by clicking on the email.
		<br />
		You can view robot information by clicking on the serial number.
		<br />
	</p>
	<form action="<?php echo $this->createUrl('usersRobot/delete') ?>" method="POST" id="usersRobotList">
		<div class="action-button-container">
			<a href="<?php echo $this->createUrl('usersRobot/add')?>" title="Add association" class="neato-button">Add</a>
			<input type='button' value='Delete' id='deleteSelected' class='deleteSelected neato-button' title="Delete association" />
		</div>
			...
			<tbody>
				...
				<tr>
					<td class='pretty-table-center-td'>
						<input type="checkbox" name="chooseoption[]" value="<?php echo $user_robot->id;?>" class='choose-option'>
					</td>
					<td>
						<a
							...
							class='qtiplink' title="View details of (<?php echo($user_robot->idUser->email);?>)">
							<?php echo($user_robot->idUser->email)?>
						</a>
					</td>
					<td>
						<a
							...
							class='qtiplink robot-qtip' title="View details of (<?php echo $user_robot->idRobot->serial_number?>)">
							<?php echo($user_robot->idRobot->serial_number);?>
						</a>
					</td>
				</tr>
				<?php } ?>
