...
<fieldset class='data-container static-data-container'>
	...
	<form action=" " method="POST" id="appList">
		...
		<div class="action-button-container">
			<a href="<?php echo $this->createUrl('app/add')?>"
				title="Add app version" class="neato-button">Add</a> 
		</div>
		...
		<thead>
			<tr>
				<th style="width: 25%;"  class='pretty-table-center-th'>App ID</th>
				<th style="width: 40%;"  class='pretty-table-center-th'>Current Version</th>
				<th style="width: 40%;"  class='pretty-table-center-th'>OS Type</th>
				<th style="width: 50%;"  class='pretty-table-center-th'>OS Version</th>
				<th style="width: 25%;"  class='pretty-table-center-th'>Latest Version</th>
				<th style="width: 70%;"  class='pretty-table-center-th'>Latest Version URL</th>
				<th style="width: 45%;"  class='pretty-table-center-th'>Upgrade Status</th>
				<?php if($isAdmin){?>
				<th style="width: 30%;"  class='pretty-table-center-th'></th>
				<th style="width: 32%;"  class='pretty-table-center-th'></th>
				<?php }?>
