...
<fieldset class='data-container static-data-container'>
	...
	<p class="list_details">
		Click Start Cleaning Button to send start cleaning command to this robot.
		<br />
	...
	<p class="list_details">
		...
		<br />
		Click on delete to delete a specific robot schedule.
		<br />
		<?php }?>
		Click on the XML file links to see a quick view.
		<br />
		Click on the Binary data file links to see a quick view.
		<br />
		Click on the download button inside the quick view to download it to your desktop.
		<br />
		<?php }else{?>
		<?php if ($isAdmin){?>
		...
		<table class="pretty-table robot-schedule-table">
			<thead>
				<tr>
					...
					<th title="XML Version number" class='pretty-table-center-th'>XML version</th>
					<th title="Binary data Version" class='pretty-table-center-th'>Binary data version</th>
					<?php if ($isAdmin){?>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a class='qtipPopuplink' title="Xml Schedule <?php echo $schedule->id;?> for Robot <?php echo $model->serial_number;?>"
							...
							target="_blank">
							<?php echo $schedule->xml_data_file_name;?>
						</a>
					</td>
					<td>
						<a class='qtipPopuplink' title="Blob Schedule <?php echo $schedule->id;?> for Robot <?php echo $model->serial_number;?>"
							...
							target="_blank">
							<?php echo $schedule->blob_data_file_name;?>
						</a>
					</td>
					<td class='pretty-table-center-td'>
						<?php echo $schedule->XMLDataLatestVersion;?>
					</td>
					<td class='pretty-table-center-td'>
						<?php echo $schedule->BlobDataLatestVersion;?>
					</td>
					<?php if ($isAdmin){?>
					<td class='pretty-table-center-td'>
						<a
							...
							title="Edit robot schedule <?php echo $model->serial_number?>" class="qtipPopuplink  look-like-a-link ">edit</a>
					</td>
					<td class='pretty-table-center-td'>
						<div class="delete-single-robot-schedule look-like-a-link "
