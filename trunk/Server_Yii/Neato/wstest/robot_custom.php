...
<?php include_once 'common_header.php';?>
	...
	<form action="<?php echo($baseURL)?>robot.post_custom_data"
		...
		<table class='custom_table'>
			<tr>
				<td id = "Post Robot Custom Data" colspan="2"><label>Post Robot Custom Data</label>
				</td>
			</tr>
			<tr>
	...
	<form action="<?php echo($baseURL)?>robot.get_customs" method='POST'
		...
		<table class='custom_table'>
			<tr>
				<td id = "Get Robot Customs" colspan="2"><label>Get Robot Customs</label>
				</td>
			</tr>
			<tr>
				<td colspan="2" class='api_description'>
	...
	<form action="<?php echo($baseURL)?>robot.get_custom_data"
		...
		<table class='custom_table'>
			<tr>
				<td id = "Get Robot Custom Data" colspan="2"><label>Get Robot Custom Data</label>
				</td>
			</tr>
			<tr>
				<td colspan="2" class='api_description'>
	...
	<form action="<?php echo($baseURL)?>robot.update_custom_data"
		...
		<table class='custom_table'>
			<tr>
				<td id = "Update Robot Custom Data" colspan="2"><label>Update Robot Custom Data</label>
				</td>
			</tr>
			<tr>
				<td colspan="2" class='api_description'>
	...
	<form action="<?php echo($baseURL)?>robot.delete_custom_data"
		...
		<table class='custom_table'>
			<tr>
				<td id = "Delete Robot Custom Data" colspan="2"><label>Delete Robot Custom Data</label>
				</td>
			</tr>
			<tr>
				<td colspan="2" class='api_description'>
