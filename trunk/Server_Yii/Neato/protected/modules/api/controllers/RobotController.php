    ...
    public function actionClearRobotAssociation() {
        ...
        if ($is_delete == '0') {
            ...
            if ($current_robot_type_id != $defualt_robot_type_id) {
                ...
                $robot_robot_type->save();
//                $robot_schedule_type->updateAll(array('robot_type_id' => $default_robot_type), 'robot_id = :robot_id', array(':robot_id' => $robot->id));
            }
...
//            foreach ($robot_key_value as $key_value_robot) {
//                RobotKeyValues::model()->deleteAll('robot_id = :robot_id', array(':robot_id' => $robot_id_type));
//            }
...
//            if ($schedule_count) {
//                $response_data = array('success' => true, 'message' => 'Robot is Already Cleaned.');
//                self::success($response_data);
//                    $count = "";
//            }
...
//            foreach ($users_arr as $user_ids) {//delete all asscociated user with its all data
//                User::model()->deleteAll('id= :id', array(':id' => $user_ids));
//            }
