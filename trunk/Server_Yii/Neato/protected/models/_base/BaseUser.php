...
class BaseUser extends GxActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
				...
				array('id, name, password, reset_password, email, is_emailVerified, is_admin, created_on, chat_id, chat_pwd, is_active, validation_key, is_validated, validation_counter, alternate_email, push_notification_preference, extram_param, country_code, opt_in, language', 'safe', 'on'=>'search'),
		);
	}
