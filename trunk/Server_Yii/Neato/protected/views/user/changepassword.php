...
<fieldset class='data-container static-data-container'>
	...
	<p class="list_details">
		...
		<br />
		If current password matches your existing password, your password would be updated with the new password.
	</p>
	<div class="form">
		...
		<div class="row-buttons change-password-buttons">
			...
			<a href="<?php echo $this->createUrl('user/userprofile')?>" title="Cancel" class="neato-button">Cancel</a>
		</div>
		<?php $this->endWidget(); ?>
	</div>
	<!-- form -->
