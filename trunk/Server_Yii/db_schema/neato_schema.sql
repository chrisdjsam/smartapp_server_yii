...
--
-- Host: localhost
-- Generation Time: Jan 09, 2014 at 09:09 PM
...
INSERT INTO `country_code_list` (`id`, `iso2`, `short_name`, `long_name`, `iso3`, `numcode`, `un_member`, `calling_code`, `cctld`) VALUES
...
(251, '0', 'Other', 'Other', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `notification_logs` (
  ...
  `notification_to` longtext CHARACTER SET utf8,
...
CREATE TABLE IF NOT EXISTS `notification_registrations` (
  ...
  `application_id` longtext CHARACTER SET utf8,
  `notification_server_type` longtext CHARACTER SET utf8,
  `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `online_chat_ids`
--

CREATE TABLE IF NOT EXISTS `online_chat_ids` (
...
CREATE TABLE IF NOT EXISTS `robots` (
  ...
  `updated_on` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT 'UTC Timestamp',
  `created_on` varchar(500) CHARACTER SET utf8 COLLATE utf8_estonian_ci DEFAULT NULL COMMENT 'UTC Timestamp',
  PRIMARY KEY (`id`),
...
(1, 'key', '2013-08-27 15:06:17'),
(2, 'name', '2013-08-27 15:06:18');
...
--
-- Table structure for table `robot_linking_code`
--

CREATE TABLE IF NOT EXISTS `robot_linking_code` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `email` varchar(128) CHARACTER SET utf8 NOT NULL,
  `serial_number` varchar(100) CHARACTER SET utf8 NOT NULL,
  `current_linking_state` bigint(20) NOT NULL,
  `linking_code` text CHARACTER SET utf8,
  `linking_code_created_on` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `robot_user_association_tokens`
--

CREATE TABLE IF NOT EXISTS `robot_user_association_tokens` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `robot_id` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `extram_param` varchar(10000) CHARACTER SET utf8 NOT NULL DEFAULT '{"country_code":"US","opt_in":"true"}',
  `country_code` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT 'US',
...
CREATE TABLE IF NOT EXISTS `users_socialservices` (
  ...
  `raw_data` longtext CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_user` (`id_user`),
...
CREATE TABLE IF NOT EXISTS `ws_logging` (
  ...
  `response_time` varchar(500) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `xmpp_message_logs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `xmpp_message` longtext CHARACTER SET utf8,
  `send_from` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `send_at` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `xmpp_notification_via_mq`
--

CREATE TABLE IF NOT EXISTS `xmpp_notification_via_mq` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `xmpp_uid` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `from` text CHARACTER SET utf8,
  `to` text CHARACTER SET utf8,
...
ALTER TABLE `notification_registrations`
  ADD CONSTRAINT `notification_registrations_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `robot_key_values`
  ADD CONSTRAINT `robot_key_values_ibfk_2` FOREIGN KEY (`robot_id`) REFERENCES `robots` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `user_push_notification_preferences`
  ADD CONSTRAINT `user_push_notification_preferences_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
